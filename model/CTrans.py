...
import numpy as np
from model.Trans import SwinTransformer
...
class CMorph(nn.Module):
    def __init__(self):
        super(CMorph, self).__init__()
        ...
        self.up1 = DecoderBlock(256, 128, skip_channels=128, use_batchnorm=False)  # 384, 20, 20, 64
        self.up2 = DecoderBlock(128, 64, skip_channels=128, use_batchnorm=False)  # 384, 40, 40, 64
        self.up3 = DecoderBlock(64, 32, skip_channels=64, use_batchnorm=False)  # 384, 80, 80, 128
        self.up4 = DecoderBlock(32, 16, skip_channels=32, use_batchnorm=False)  # 384, 160, 160, 256
