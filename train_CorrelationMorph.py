...
from model.CTrans import CMorph
...
def main():
    ...
    save_dir = 'CMorph_ncc_{}_diffusion_{}/'.format(weights[0], weights[1])
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        }, save_dir='experiments/'+save_dir, filename='dsc{:.4f}epoch{:04d}.pth.tar'.format(eval_dsc.avg, epoch))
